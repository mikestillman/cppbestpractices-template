...
// configuration step. It creates a namespace called `cppbestpractices_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cppbestpractices_template::cmake::project_name, cppbestpractices_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cppbestpractices_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
